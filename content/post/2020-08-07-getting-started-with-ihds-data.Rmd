...
# Accessing the data
Accessing IHDS data is pretty straightforward. You can go to the IHDS webpage [here](https://ihds.umd.edu/), click on "Download Data", and follow the appropriate links or you can just click on the links below. Note that you will have to create a login ID. For more information on which specific files to download, see the next below.
